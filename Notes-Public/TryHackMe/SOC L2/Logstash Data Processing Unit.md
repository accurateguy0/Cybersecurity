...
![](https://miro.medium.com/v2/resize:fit:700/1*9Wd6qIfY61QkRkDmkoXeGA.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*htF0l57I7g-nWO4HXoAwcA.png)

To access the lab via SSH, use the following credentials.

Press enter or click to view image in full size

![](https://miro.medium.com/v2/resize:fit:700/0*HLouG6UVu05UDzDU.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*0CHo2X0MWg-JSaDvdgRO1w.png)

If you entered it correctly. You will be greated with a way of text. Then finally, CLI (Command Line Interface).

Press enter or click to view image in full size

![](https://miro.medium.com/v2/resize:fit:700/1*SAAX55hL7XGKk_-J9y2EEw.png)
...
![](https://miro.medium.com/v2/resize:fit:172/1*bLe8JSTuZOK_gOU-diIQSg.png)
...
![](https://miro.medium.com/v2/resize:fit:700/0*3xLhPt0iws6Ld3Lv.png)
...
![](https://miro.medium.com/v2/resize:fit:632/1*7pcfV04dKxivKmqmoh-OFw.png)
...
![](https://miro.medium.com/v2/resize:fit:679/1*uOjus29xpmeuTX5ZiWtBvA.png)
...
![](https://miro.medium.com/v2/resize:fit:678/1*theD1kqlGrTMmGZEYOfGHg.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*YMqM1Tz9eLj7vBOYVLkHtg.png)
...
![](https://miro.medium.com/v2/resize:fit:673/1*5AgTKF36j_pbCkzpH05yfA.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*VH9EdMrUlP3jboNXMzX6ZA.png)
...
![](https://miro.medium.com/v2/resize:fit:188/1*JJkFGt4ftTpBkHqfFkdJvw.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*-uv-WrasvsEtkM-Y--IQxQ.png)
...
![](https://miro.medium.com/v2/resize:fit:683/1*efkC7RdjTrJ7uPZnhNnSlg.png)
...
![](https://miro.medium.com/v2/resize:fit:665/1*bybQylLrfaNbyr2dC7R8wQ.png)
...
![](https://miro.medium.com/v2/resize:fit:120/1*jmrHxMypv0s0AxmsXVA7Cw.png)
...
![](https://miro.medium.com/v2/resize:fit:674/0*kEHqgi7CP6zHmndG.png)
...
![](https://miro.medium.com/v2/resize:fit:700/0*9P1teRVdtAFb77sM.png)

Congrats, ELK is installed properly:

Press enter or click to view image in full size

![](https://miro.medium.com/v2/resize:fit:700/0*pxOd_24wpEYTQIxM.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*ahYvHFYH0sXStKuUsqL5Kg.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*ETQ_Mhidzwl89LNKY0M8Vw.png)
...
![](https://miro.medium.com/v2/resize:fit:618/1*fSlVyXlP8VYnE1PRCTNUqA.png)
...
![](https://miro.medium.com/v2/resize:fit:660/1*foXyoiWtevHadBh0wRaqaA.png)
...
![](https://miro.medium.com/v2/resize:fit:700/0*l1-b4GdpkRM0zI7m.png)

Below is the list of the top 10 input plugins with a brief explanation:

Press enter or click to view image in full size

![](https://miro.medium.com/v2/resize:fit:700/1*mcPQ_TUVIuqEJjTlHc2adQ.png)
...
![](https://miro.medium.com/v2/resize:fit:700/0*o4_NYOrQp_0BLmF1.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*d-Hqe0k6tN2n-c_wbsTbqg.png)
...
![](https://miro.medium.com/v2/resize:fit:700/0*bvoeh0IPd40DVHMT.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*nBjJOFvfKL0nlZfcARagAA.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*-gbKXMKoqmbgOAeKKQcr_w.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*Y8B2gmizvUpIRyk9TdX0vQ.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*YZPdpEXbDeiRQEA2ipkpug.png)
...
](https://medium.com/plans?source=upgrade_membership---post_li_non_moc_upsell--fbc0b021aa61---------------------------------------)
...
![](https://miro.medium.com/v2/resize:fit:700/0*Uy-32sBzllJgFI2M.png)
...
![](https://miro.medium.com/v2/resize:fit:700/0*w663iNx0_4u3u1Ca.png)
...
![](https://miro.medium.com/v2/resize:fit:700/0*NNhd7z0cemEYTjCB.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*IyQofcn0IG5GNbROOKpNMA.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*LWPDSTT-a_SbPKaQ9y0NJg.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*UkmpdnLUO9uR8HGz339s_w.png)

We should now be on the _File input plugin_ page. Time to scroll down till we see _File Input Configuration Options_.

Press enter or click to view image in full size

![](https://miro.medium.com/v2/resize:fit:700/1*3J1KEpMTvL07HtBxdZhFxQ.png)
...
![](https://miro.medium.com/v2/resize:fit:693/1*hytRwQ9lr28NPkkc3ZeXZg.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*iePIMKSwfbFm24lV95pGmQ.png)

![](https://miro.medium.com/v2/resize:fit:285/1*cLeFtExskcZ8HpULvDBn3A.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*E3C3YtqwrrQrCipxoJdEig.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*4DnAKMmOtca4NUCYE4ZIXw.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*_cicprYvu59FJkeoIue6rw.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*NxdneQHUG1nPCgwwqhxWNA.png)

## Task 8 Logstash: Input Configurations

![](https://miro.medium.com/v2/resize:fit:514/1*QmXtkv5CqPVgRG_UOSp1eA.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*crkqJXsmujDkhHy418YwBA.png)
...
![](https://miro.medium.com/v2/resize:fit:467/1*4A0w7V9opAbarBLXr5XuUg.png)

Press enter or click to view image in full size

![](https://miro.medium.com/v2/resize:fit:700/1*g07B8gFtD64GvIQEAKpDUQ.png)

## Task 9 Logstash: Filter Configurations

### Filters

![](https://miro.medium.com/v2/resize:fit:583/1*3YWwATxrUkTiFImtsnDC_Q.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*YceCs-MXnhmlF1Xm4eC6eg.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*3GaklWb_G-XCeDgUa_y75w.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*PuV-Y85NcbFPSw5iL30PDg.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*lIApPP2bUEwwOTjAy8jGoQ.png)

_ANSWER: rename => { “src_ip” => “source_ip” }_

## Task 10 Logstash: Output Plugins

![](https://miro.medium.com/v2/resize:fit:583/1*bE4pSxA1xce9BmCvd5sq2w.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*Z2KG5JrX6_wxr7F6RXpnBQ.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*JrN-zwVeYzDWHc1TcavS0A.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*xdIlRVFYCZMx9BHKHidthw.png)
...
![](https://miro.medium.com/v2/resize:fit:584/1*o_sVnCPJhrXVJjvzxwEoPQ.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*rjAk1xLsOPgnUfh6bWwezw.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*xpYFW0pjX7ZuXAVScQOkSw.png)
...
![](https://miro.medium.com/v2/resize:fit:671/1*UnWk9V00Vcjhv-fAqG16tg.png)

Reading through the _Description_, it looks like we found our Winner for the filter!!!

Press enter or click to view image in full size

![](https://miro.medium.com/v2/resize:fit:700/1*nrnkk0QugT1k-MnWRe_WBw.png)
...
![](https://miro.medium.com/v2/resize:fit:700/1*rGGJk5Z1PvO34S8Ph42M5g.png)
